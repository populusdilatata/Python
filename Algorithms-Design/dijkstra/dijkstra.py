...
def findshortestPath(G, start, end):
    ...
    Note: This method is not needed in the current exercise, however,
    it would be nice to know the shortest path from one vertex to another sometimes"""
...
def main():
    G = make_graph('dijkstraDataA.txt')
