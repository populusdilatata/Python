...
# and time-and-a-half for the hourly rate for all hours worked 
# above 40 hours. Put the logic to do the computation of pay 
# in a function called computepay() and use the function 
...
# unless you want to - you can assume 
# the user types numbers properly. Do not name 
