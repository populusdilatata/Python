...
# (i.e. the entire address of the person 
# who sent the message). Then print out a count 
# at the end.
#
# Hint: make sure not to include the lines that start
# with 'From:'. Also look at the last line of 
# the sample output to see how to print the count.
# 
# You can download the sample data 
# at http://www.py4e.com/code3/mbox-short.txt
