...
print("1False", delete_account(user_accounts,log_in,bank,"BrandonK","123abcABC"))
print("2False", delete_account(user_accounts,log_in,bank,"Brandon","123abcABDC"))
print("3False", delete_account(user_accounts,log_in,bank,"Brandon","brandon123ABC"))
login(user_accounts,log_in,"Brandon","brandon123ABC")

print("4True", delete_account(user_accounts,log_in,bank,"Brandon","brandon123ABC"))
print(bank)
print(user_accounts)
print(log_in)
